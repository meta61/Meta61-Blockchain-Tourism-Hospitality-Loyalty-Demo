...
if (isset($_POST['create'])) {
    ...
    $sql = "INSERT INTO customers (name,description) VALUES ('$name', '$description')";
    $conn->query($sql);

    //API Login
    $_SESSION['registerResponse'] = registerUser($_SESSION["username"], "Org2", "$name");
}
...
if (isset($_POST['update'])) {
    ...
    $sql = "UPDATE customers SET name='$name', description='$description' WHERE id=$id";
    $conn->query($sql);
